 ...
 */
public abstract class QueryExecTracked<T extends QueryExec> implements QueryExec {
    private T delegate;
    private ThrowableTracker throwableTracker;
    private QueryType queryExecType = null;

    /**
     * Create a new QueryExecTracked.
     *
     * @param delegate the delegate QueryExec
     * @param tracker the exception tracker
     */
    public QueryExecTracked(T delegate, ThrowableTracker tracker) {
        super();
    ...
    /**
     * Get the underlying delegate QueryExec.
     *
     * @return the delegate
     */
    ...
    /**
     * Get the exception tracker used to report errors.
     *
     * @return the throwable tracker
     */
    ...
    /**
     * The query type requested for execution. For example, calling select() sets this type to {@link
     * QueryType#SELECT}.
     *
    ...
    /**
     * Wrap a RowSet with exception tracking.
     *
     * @param base the base RowSet to wrap
     * @return the tracked RowSet
     */
    ...
    /**
     * Wrap an Iterator with exception tracking.
     *
     * @param base the base Iterator to wrap
     * @param <X> the element type
     * @return the tracked Iterator
     */
