...
/** Broker (sink + source) that stores the last n events. */
    ...
    extends TaskEventBroker
{
    ...
    protected ConcurrentNavigableMap<Long, HasBasicTaskExec> serialToTask = new ConcurrentSkipListMap<>();

    protected int maxHistorySize = 1000;

    // History is indexed by serial id.
    protected ConcurrentLinkedDeque<Entry<Long, HasBasicTaskExec>> history = new ConcurrentLinkedDeque<>();
